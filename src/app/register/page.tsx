    ...
    return (
        <>
            <section className='relative mb-20 conatiner mx-auto'>
                <Image className='w-full h-[400px] lg:h-[500px] object-cover' alt="Image of server in web2" src={image} />
            ...
            <section className=" flex justify-center containet mx-auto px-4 lg:px-8">
